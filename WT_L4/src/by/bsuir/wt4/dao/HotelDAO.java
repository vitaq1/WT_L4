...
public class HotelDAO {
    public Logger log = Logger.getLogger(HotelDAO.class.getName());
    ArrayList list = null;
    ...
    public boolean isvalidUser(String userName, String passWord) throws HotelException {
        ...
        try {
            try {
                ...
                preparedStatement = connection.prepareStatement("select password from login_hotel where USERNAME=?");
    ...
    public boolean addValues(ArrayList<ReservBean> rbList, String id) throws HotelException {
        ...
        try {
            connection = new DBConnection().getConnection();
            Iterator<ReservBean> iterator = rbList.iterator();

            while (iterator.hasNext()) {
                ReservBean bean = iterator.next();
                String hotelId = null;
