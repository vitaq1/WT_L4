...
<%@page
	import="java.util.ArrayList,java.util.List,by.bsuir.wt4.bean.ReservBean,java.util.Iterator;"%>
...
<table border="1" align="center">
	...
	<%
	  ReservBean rb;
		...
		ArrayList<ReservBean> rbList = (ArrayList<ReservBean>)session.getAttribute("ReservationCart");
		Iterator<ReservBean> ReservationBeanIterator = rbList.iterator();
...

		{
			...
			//ReservationBean rbs=ReservationBeanIterator.next();
			 rb = (ReservBean) ReservationBeanIterator.next();
