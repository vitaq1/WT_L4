...
<%@page import="java.util.ArrayList,by.bsuir.wt4.bean.ReservBean,java.util.List,java.util.Iterator;"%>
...
if(newSession!=null)
{
	ArrayList<ReservBean> list1=null;

	list1=(ArrayList<ReservBean>)newSession.getAttribute("ReservationCart");
	
		newSession.setAttribute("ReservationCart",list1);
	%>
	<jsp:include page="ReservCart.jsp" flush="true"/>
	<%
